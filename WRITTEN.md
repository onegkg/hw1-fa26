...
<!--
Outline
    - [x] First paragraph: Theory is necessary, so what?
    - [x] Second paragraph: Why do I accept tools when Naur rejects method based programming?
    - [?] Third paragraph: Do LLMs disrupt this model?
-->
